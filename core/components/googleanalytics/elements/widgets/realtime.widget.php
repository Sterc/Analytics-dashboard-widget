...
class GoogleAnalyticsRealtimeDashboardWidget extends modDashboardFileWidget
{
    /**
     * @access public.
     * @var String.
    ...
    public function render()
    {
        if ($this->modx->hasPermission('googleanalytics')) {
            ...
            if ($profile) {
                ...
                $this->modx->regClientStartupScript($this->modx->googleanalytics->config['js_url'] . 'mgr/sections/realtime.widget.js');
                ...
                return $this->modx->smarty->fetch($this->modx->googleanalytics->config['templates_path'] . 'widgets/realtime.tpl');
            }
        }
    }
}

return 'GoogleAnalyticsRealtimeDashboardWidget';
