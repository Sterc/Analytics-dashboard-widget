...
$_lang['googleanalytics.desc']                                  = 'View the Google Analytics data.';
...
$_lang['setting_googleanalytics.history_desc']                  = 'The number of days to show (min: 7, max: 30 day)s. Default is "14".';
$_lang['setting_googleanalytics.cache_lifetime']                = 'Caching';
$_lang['setting_googleanalytics.cache_lifetime_desc']           = 'The time that the stats needs to be cached, after this time they will be refreshed. Default is "1800".';
...
$_lang['googleanalytics.label_code_desc']                       = 'The authorization token to get access to the Goolge Analytics data.';
$_lang['googleanalytics.label_get_code']                        = 'Get authorization token';
...
$_lang['googleanalytics.label_history_desc']                    = 'Display data for this amount of days. Default is "14".';
$_lang['googleanalytics.label_cache_lifetime']                  = 'Caching';
$_lang['googleanalytics.label_cache_lifetime_desc']             = 'The time that the stats needs to be cached, after this time they will be refreshed. Default is "1800".';

$_lang['googleanalytics.stats_desc']                            = 'Google Analytics is a Google service to show statistics and trends of your visitors.';
$_lang['googleanalytics.open_googleanalytics']                  = 'Google Analytics';
$_lang['googleanalytics.auth_create']                           = 'Authorize';
$_lang['googleanalytics.auth_create_desc']                      = 'Click on the button \'' . $_lang['googleanalytics.label_get_code'] . '\' to get a Google Analytics authorization token. This token gives you access to the stats and copy/past this in the textfield down here.';
$_lang['googleanalytics.auth_remove']                           = 'Revoke authorization';
$_lang['googleanalytics.auth_remove_confirm']                   = 'Are you sure you want to revoke the authorization?';
$_lang['googleanalytics.refresh_settings']                      = 'Refresh';
$_lang['googleanalytics.refresh_settings_confirm']              = 'By default the Google Analytics stats are cached 30 minutes by default, are you sure you want to refresh the stats?';
...
$_lang['googleanalytics.title_block_summary']                   = 'Stats of [[+date_1]] till [[+date_2]]';
$_lang['googleanalytics.title_block_meta']                      = 'Stats compared last [[+history]] days';
$_lang['googleanalytics.title_block_speed']                     = 'Site speed last [[+history]] days';
...
$_lang['googleanalytics.page_load_time']                        = 'Avg. page loadtime (sec)';
$_lang['googleanalytics.domain_lookup_time']                    = 'Avg. domain lookup time (sec)';
$_lang['googleanalytics.page_download_time']                    = 'Avg. page download time (sec)';
$_lang['googleanalytics.redirection_time']                      = 'Avg. bypass time (sec)';
$_lang['googleanalytics.server_connection_time']                = 'Avg. server connection time (sec)';
$_lang['googleanalytics.server_response_time']                  = 'Avg. server response time (sec)';
...
$_lang['googleanalytics.no_oauth']                              = 'MODx does not have access to your Google Analytics account, make sure that MODx has access to display te stats.';

$_lang['googleanalytics.no_oauth_title']                        = 'Authorize Google Analytics';
$_lang['googleanalytics.no_oauth_content']                      = '<ol class="x-list-decimal"><li>First we need to create <a href="https://console.cloud.google.com/apis/api/analytics.googleapis.com/overview" target="_blank" rel="noopener">Google Analytics API credentials</a> to be able to get data from Google Analytics.</li><li>Navigate to System Settings and search for "googleanalytics.client". Enter your Google Analytics API Client ID and API Key.</li><li>Click the "Authorize" button on the top right to get an authorization code.</li><li>Click the "Settings" button and select your profile.</li><li>Add Analytics Widgets to your dashboard. There is a visitors and realtime widget available.</li></ol>';
