...
class GoogleAnalyticsGetProfilesProcessor extends modObjectProcessor
{
    /**
     * @access public.
     * @var Array.
    ...
    public function process()
    {
        ...
        $data = $this->modx->googleanalytics->getRequest()->getAccountProfiles($this->getProperty('account'), $this->getProperty('property'));
...
return 'GoogleAnalyticsGetProfilesProcessor';
